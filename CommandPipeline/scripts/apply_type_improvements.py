...
def apply_type_improvements(commands, manual_overrides, scraped_types, dry_run=False):
    ...
    return commands, stats, new_manifest_entries
...
def main():
    ...
    updated_commands, stats, new_manifest_entries = apply_type_improvements(commands, manual_overrides, scraped_types, dry_run=args.dry_run)

    # Update manifest map with new entries (overwriting old ones for same command)
